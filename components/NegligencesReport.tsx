...
/**
 * Rapport consolidé de TOUTES les négligences — destiné au Directeur général
...
export function NegligencesReport({ negs }: { negs: Negligence[] }) {
  ...
  return createPortal(
    <div className="print-report">
      ...
      <div style={{ fontSize: 15, fontWeight: 700, margin: "6px 0 8px" }}>Décisions du Directeur général</div>
