...
import type { AppSettings, Catalogue, Contact, ConversationSummary, EmailTemplate, Item, Meeting, Negligence, NonConformite, Notif, Objective, Profile, Project, RefLists, Risk, Task } from "@/lib/domain";
