...
export const PROFILES: Profile[] = [
  { id: "u1", nom: "Direction sécurité", poste: "Responsable sécurité (RSSI)", role: "directeur", init: "DS", extraPages: [], deniedPages: [], readonly: false, approved: true, grcMember: true, mustChangePassword: false, totpEnabled: false },
  { id: "u2", nom: "Agent A", poste: "Analyste SOC / Forensic", role: "agent", init: "A1", extraPages: [], deniedPages: [], readonly: false, approved: true, grcMember: false, mustChangePassword: false, totpEnabled: false },
  { id: "u3", nom: "Agent B", poste: "Gouvernance & conformité", role: "agent", init: "A2", extraPages: [], deniedPages: [], readonly: false, approved: true, grcMember: true, mustChangePassword: false, totpEnabled: false },
  { id: "u4", nom: "Agent C", poste: "Analyste SOC", role: "agent", init: "A3", extraPages: [], deniedPages: [], readonly: false, approved: true, grcMember: false, mustChangePassword: false, totpEnabled: false },
  { id: "u5", nom: "Agent D", poste: "Renseignement menace", role: "agent", init: "A4", extraPages: [], deniedPages: [], readonly: false, approved: true, grcMember: false, mustChangePassword: false, totpEnabled: false },
  { id: "u6", nom: "Agent E", poste: "Audit / Projets", role: "agent", init: "A5", extraPages: [], deniedPages: [], readonly: false, approved: true, grcMember: true, mustChangePassword: false, totpEnabled: false },
  { id: "u7", nom: "Administration", poste: "Administrateur de l'application", role: "admin", init: "AX", extraPages: [], deniedPages: [], readonly: false, approved: true, grcMember: false, mustChangePassword: false, totpEnabled: false },
];
  ...
  return [
    {
      ...
      memberIds: ["u6", "u4", "u2"],
      tasks: [
        { id: tid(), projectId: "demo-p1", title: "Cartographier les sources de logs", assigneeId: "u4", status: "fait", startDate: null, dueDate: daysAgo(6), ordre: 1, createdAt: daysAgo(12), description: "", priority: "Normale", completedAt: null },
        { id: tid(), projectId: "demo-p1", title: "Valider la volumétrie avec l'exploitation", assigneeId: "u6", status: "en cours", startDate: null, dueDate: daysAgo(-2), ordre: 2, createdAt: daysAgo(10), description: "", priority: "Normale", completedAt: null },
        { id: tid(), projectId: "demo-p1", title: "Rédiger la procédure de bascule", assigneeId: "u2", status: "à faire", startDate: null, dueDate: daysAgo(-8), ordre: 3, createdAt: daysAgo(8), description: "", priority: "Normale", completedAt: null },
        { id: tid(), projectId: "demo-p1", title: "Fenêtre de maintenance", assigneeId: null, status: "à faire", startDate: null, dueDate: daysAgo(-18), ordre: 4, createdAt: daysAgo(8), description: "", priority: "Normale", completedAt: null },
      ],
      notes: [
    ...
    },
    {
      ...
      memberIds: ["u3", "u6"],
      tasks: [
        { id: tid(), projectId: "demo-p2", title: "Prioriser les 12 recommandations", assigneeId: "u3", status: "fait", startDate: null, dueDate: daysAgo(14), ordre: 1, createdAt: daysAgo(20), description: "", priority: "Normale", completedAt: null },
        { id: tid(), projectId: "demo-p2", title: "Corriger les comptes à privilèges", assigneeId: "u6", status: "à faire", startDate: null, dueDate: daysAgo(-5), ordre: 2, createdAt: daysAgo(18), description: "", priority: "Normale", completedAt: null },
      ],
      notes: [],
      pendingStatus: null,
      pendingBy: null,
